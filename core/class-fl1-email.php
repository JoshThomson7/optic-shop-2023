...
class FL1_Email {
    ...
    public function get_email_styles() {
        ...
        $styles = array(
            ...
            'h2' => 'font-size: 17px; color: #0A253E; font-weight: 600;',
            'h3' => 'font-size: 15.5px; color: #0A253E; font-weight: 600;',
			...
			'button' => 'background: #FFA64E; border-radius: 8px; color: #fff; display: inline-block; padding: 6px 25px; text-decoration: none; font-weight: bold;'#
        );
            ...
            <div style="' . $styles['background'] . '">
                <div style="' . $styles['wrapper'] . '">
                    ...
                    <a href="' . esc_url(home_url()) . '" title="' . get_bloginfo('name') . '" style="' . $styles['logo']['a'] . '">
                        <img src="' . esc_url(get_stylesheet_directory_uri()) . '/img/logo-email.png" alt="' . get_bloginfo('name') . '" style="' . $styles['logo']['img'] . '">
                    </a>
