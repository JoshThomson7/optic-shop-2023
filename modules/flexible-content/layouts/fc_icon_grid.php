...
<div class="fc_icon_grid_wrapper <?php echo $text_align; ?>">
    ...
    ?>
        <article class="<?php echo $items_per_row; ?>">
			<div class="padder">
				<?php
					if(get_sub_field('icon_grid_links_to')):
						$target = '';
						if(strpos(get_sub_field('icon_grid_links_to'), 'wavelength') === false) {
							$target = ' target="_blank"';
						}
				?>
					<a href="<?php the_sub_field('icon_grid_links_to') ?>"<?php echo $target; ?>>
				<?php endif; ?>
